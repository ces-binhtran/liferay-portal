...
SearchContainer dlSearchContainer = new SearchContainer(liferayPortletRequest, null, null, "curEntry", numberItemsShowDelta, portletURL, null, null);
